 ...
 */
     ...
     */
    typedef int (*GEOSDistanceCallback)(const void *item1, const void *item2,
                                        double *distance, void *userdata);

    /**
     * Callback function for use in GEOSGeom_transformXY.
     * Allows custom function to be applied to x and y values for each
     * coordinate in a geometry.  Z values are unchanged by this function. Extra
     * data for the calculation can be passed via the userdata.
     *
     ...
     */
    typedef int (*GEOSTransformXYCallback)(double *x, double *y,
                                           void *userdata);

    /* ========== Interruption ========== */

    /**
     * Callback function for use in interruption. The callback will be invoked
     * _before_ checking for interruption, so can be used to request it.
     *
     ...
     */
    extern GEOSInterruptCallback GEOS_DLL *
     ...
     * \return the previously configured message handler or NULL if no message
     * handler was configured
     */
    extern GEOSMessageHandler GEOS_DLL GEOSContext_setNoticeHandler_r(
        GEOSContextHandle_t extHandle, GEOSMessageHandler nf);
     ...
     * \param userData optional user data pointer that will be passed to the
     * message handler \return the previously configured message handler or NULL
     * if no message handler was configured
     */
    extern GEOSMessageHandler_r GEOS_DLL GEOSContext_setNoticeMessageHandler_r(
        GEOSContextHandle_t extHandle, GEOSMessageHandler_r nf, void *userData);
    ...
    extern GEOSMessageHandler_r GEOS_DLL GEOSContext_setErrorMessageHandler_r(
        GEOSContextHandle_t extHandle, GEOSMessageHandler_r ef, void *userData);

    /* ========== Coordinate Sequence functions ========== */

    /** \see GEOSCoordSeq_create */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_create_r(GEOSContextHandle_t handle, unsigned int size,
                          unsigned int dims);

    /** \see GEOSCoordSeq_copyFromBuffer */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_copyFromBuffer_r(GEOSContextHandle_t handle, const double *buf,
                                  unsigned int size, int hasZ, int hasM);

    /** \see GEOSCoordSeq_copyFromArrays */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_copyFromArrays_r(GEOSContextHandle_t handle, const double *x,
                                  const double *y, const double *z,
                                  const double *m, unsigned int size);

    /** \see GEOSCoordSeq_copyToBuffer */
    extern int GEOS_DLL GEOSCoordSeq_copyToBuffer_r(GEOSContextHandle_t handle,
                                                    const GEOSCoordSequence *s,
                                                    double *buf, int hasZ,
                                                    int hasM);

    /** \see GEOSCoordSeq_copyToArrays */
    extern int GEOS_DLL GEOSCoordSeq_copyToArrays_r(GEOSContextHandle_t handle,
                                                    const GEOSCoordSequence *s,
                                                    double *x, double *y,
                                                    double *z, double *m);
    ...
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_clone_r(GEOSContextHandle_t handle,
                         const GEOSCoordSequence *s);
    ...
    GEOSInterpolateNormalized_r(GEOSContextHandle_t handle,
                                const GEOSGeometry *g, double d);
    ...
    enum GEOSBufCapStyles
    {
        ...
        /** End is rounded, with end point of original line in the centre of the
           round cap. */
        GEOSBUF_CAP_ROUND = 1,

        /** End is flat, with end point of original line at the end of the
           buffer */
        GEOSBUF_CAP_FLAT = 2,

        /** End is flat, with end point of original line in the middle of a
           square enclosing that point */
    ...
    /** \see GEOSBufferParams_create */
    extern GEOSBufferParams GEOS_DLL *
    GEOSBufferParams_create_r(GEOSContextHandle_t handle);

    /** \see GEOSBufferParams_destroy */
    extern void GEOS_DLL GEOSBufferParams_destroy_r(GEOSContextHandle_t handle,
                                                    GEOSBufferParams *parms);

    /** \see GEOSBufferParams_setEndCapStyle */
    extern int GEOS_DLL GEOSBufferParams_setEndCapStyle_r(
        GEOSContextHandle_t handle, GEOSBufferParams *p, int style);

    /** \see GEOSBufferParams_setJoinStyle */
    extern int GEOS_DLL GEOSBufferParams_setJoinStyle_r(
        GEOSContextHandle_t handle, GEOSBufferParams *p, int joinStyle);
    ...
    extern int GEOS_DLL GEOSBufferParams_setQuadrantSegments_r(
        GEOSContextHandle_t handle, GEOSBufferParams *p, int quadSegs);

    /** \see GEOSBufferParams_setSingleSided */
    extern int GEOS_DLL GEOSBufferParams_setSingleSided_r(
        GEOSContextHandle_t handle, GEOSBufferParams *p, int singleSided);

    /** \see GEOSBufferWithParams */
    extern GEOSGeometry GEOS_DLL *
    GEOSBufferWithParams_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                           const GEOSBufferParams *p, double width);

    /** \see GEOSBufferWithStyle */
    extern GEOSGeometry GEOS_DLL *
    GEOSBufferWithStyle_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                          double width, int quadsegs, int endCapStyle,
                          int joinStyle, double mitreLimit);

    /** \see GEOSDensify */
    extern GEOSGeometry GEOS_DLL *GEOSDensify_r(GEOSContextHandle_t handle,
                                                const GEOSGeometry *g,
                                                double tolerance);
    ...
    /** \see GEOSGeom_createPoint */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createPoint_r(GEOSContextHandle_t handle, GEOSCoordSequence *s);

    /** \see GEOSGeom_createPointFromXY */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createPointFromXY_r(GEOSContextHandle_t handle, double x,
                                 double y);

    /** \see GEOSGeom_createEmptyPoint */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createEmptyPoint_r(GEOSContextHandle_t handle);

    /** \see GEOSGeom_createLinearRing */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createLinearRing_r(GEOSContextHandle_t handle,
                                GEOSCoordSequence *s);

    /** \see GEOSGeom_createLineString */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createLineString_r(GEOSContextHandle_t handle,
                                GEOSCoordSequence *s);

    /** \see GEOSGeom_createEmptyLineString */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createEmptyLineString_r(GEOSContextHandle_t handle);

    /** \see GEOSGeom_createEmptyPolygon */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createEmptyPolygon_r(GEOSContextHandle_t handle);

    /** \see GEOSGeom_createPolygon */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createPolygon_r(GEOSContextHandle_t handle, GEOSGeometry *shell,
                             GEOSGeometry **holes, unsigned int nholes);

    /** \see GEOSGeom_createCollection */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createCollection_r(GEOSContextHandle_t handle, int type,
                                GEOSGeometry **geoms, unsigned int ngeoms);

    /** \see GEOSGeom_createEmptyCollection */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createEmptyCollection_r(GEOSContextHandle_t handle, int type);

    /** \see GEOSGeom_createRectangle */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createRectangle_r(GEOSContextHandle_t handle, double xmin,
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSIntersectionPrec_r(GEOSContextHandle_t handle, const GEOSGeometry *g1,
    ...
    /** \see GEOSConcaveHull */
    extern GEOSGeometry GEOS_DLL *GEOSConcaveHull_r(GEOSContextHandle_t handle,
                                                    const GEOSGeometry *g,
                                                    double ratio,
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonHullSimplify_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                              unsigned int isOuter, double vertexNumFraction);

    /** \see GEOSPolygonHullSimplifyByArea */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonHullSimplifyMode_r(GEOSContextHandle_t handle,
                                  const GEOSGeometry *g, unsigned int isOuter,
                                  unsigned int parameterMode, double parameter);

    /** \see GEOSConcaveHullOfPolygons */
    extern GEOSGeometry GEOS_DLL *GEOSConcaveHullOfPolygons_r(
        GEOSContextHandle_t handle, const GEOSGeometry *g, double lengthRatio,
        unsigned int isTight, unsigned int isHolesAllowed);

    /** \see GEOSMinimumRotatedRectangle */
    extern GEOSGeometry GEOS_DLL *
    GEOSMinimumRotatedRectangle_r(GEOSContextHandle_t handle,
                                  const GEOSGeometry *g);

    /** \see GEOSMaximumInscribedCircle */
    extern GEOSGeometry GEOS_DLL *
    GEOSMaximumInscribedCircle_r(GEOSContextHandle_t handle,
                                 const GEOSGeometry *g, double tolerance);

    /** \see GEOSLargestEmptyCircle */
    extern GEOSGeometry GEOS_DLL *
    GEOSLargestEmptyCircle_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                             const GEOSGeometry *boundary, double tolerance);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSMinimumClearanceLine_r(GEOSContextHandle_t handle,
                               const GEOSGeometry *g);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSDifferencePrec_r(GEOSContextHandle_t handle, const GEOSGeometry *g1,
                         const GEOSGeometry *g2, double gridSize);

    /** \see GEOSSymDifference */
    extern GEOSGeometry GEOS_DLL *
    GEOSSymDifference_r(GEOSContextHandle_t handle, const GEOSGeometry *g1,
                        const GEOSGeometry *g2);

    /** \see GEOSSymDifferencePrec */
    extern GEOSGeometry GEOS_DLL *
    GEOSSymDifferencePrec_r(GEOSContextHandle_t handle, const GEOSGeometry *g1,
                            const GEOSGeometry *g2, double gridSize);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSUnaryUnionPrec_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                         double gridSize);

    /** \see GEOSCoverageUnion */
    extern GEOSGeometry GEOS_DLL *
    GEOSCoverageUnion_r(GEOSContextHandle_t handle, const GEOSGeometry *g);

    /** \see GEOSPointOnSurface */
    extern GEOSGeometry GEOS_DLL *
    GEOSPointOnSurface_r(GEOSContextHandle_t handle, const GEOSGeometry *g);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSMinimumBoundingCircle_r(GEOSContextHandle_t handle,
    ...
    GEOSPolygonize_r(GEOSContextHandle_t handle,
                     const GEOSGeometry *const geoms[], unsigned int ngeoms);

    /** \see GEOSPolygonize_valid */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonize_valid_r(GEOSContextHandle_t handle,
                           const GEOSGeometry *const geoms[],
                           unsigned int ngems);

    /** \see GEOSPolygonizer_getCutEdges */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonizer_getCutEdges_r(GEOSContextHandle_t handle,
                                  const GEOSGeometry *const geoms[],
                                  unsigned int ngeoms);

    /** \see GEOSPolygonize_full */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonize_full_r(GEOSContextHandle_t handle, const GEOSGeometry *input,
                          GEOSGeometry **cuts, GEOSGeometry **dangles,
                          GEOSGeometry **invalidRings);

    /** \see GEOSBuildArea */
    extern GEOSGeometry GEOS_DLL *GEOSBuildArea_r(GEOSContextHandle_t handle,
                                                  const GEOSGeometry *g);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSLineMergeDirected_r(GEOSContextHandle_t handle, const GEOSGeometry *g);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSTopologyPreserveSimplify_r(GEOSContextHandle_t handle,
                                   const GEOSGeometry *g, double tolerance);

    /** \see GEOSGeom_extractUniquePoints */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_extractUniquePoints_r(GEOSContextHandle_t handle,
                                   const GEOSGeometry *g);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSDelaunayTriangulation_r(GEOSContextHandle_t handle,
                                const GEOSGeometry *g, double tolerance,
                                int onlyEdges);

    /** \see GEOSConstrainedDelaunayTriangulation */
    extern GEOSGeometry GEOS_DLL *
    GEOSConstrainedDelaunayTriangulation_r(GEOSContextHandle_t handle,
                                           const GEOSGeometry *g);

    /** \see GEOSVoronoiDiagram */
    extern GEOSGeometry GEOS_DLL *
    GEOSVoronoiDiagram_r(GEOSContextHandle_t extHandle, const GEOSGeometry *g,
                         const GEOSGeometry *env, double tolerance,
                         int onlyEdges);

    /** \see GEOSSegmentIntersection */
    extern int GEOS_DLL GEOSSegmentIntersection_r(GEOSContextHandle_t extHandle,
    ...
    /** \see GEOSPrepare */
    extern const GEOSPreparedGeometry GEOS_DLL *
    GEOSPrepare_r(GEOSContextHandle_t handle, const GEOSGeometry *g);

    /** \see GEOSPreparedGeom_destroy */
    extern void GEOS_DLL GEOSPreparedGeom_destroy_r(
        GEOSContextHandle_t handle, const GEOSPreparedGeometry *g);
    ...
    extern char GEOS_DLL GEOSPreparedContainsProperly_r(
        GEOSContextHandle_t handle, const GEOSPreparedGeometry *pg1,
        const GEOSGeometry *g2);
    ...
    extern GEOSCoordSequence GEOS_DLL *
    GEOSPreparedNearestPoints_r(GEOSContextHandle_t handle,
                                const GEOSPreparedGeometry *pg1,
                                const GEOSGeometry *g2);

    /** \see GEOSPreparedDistance */
    extern int GEOS_DLL GEOSPreparedDistance_r(GEOSContextHandle_t handle,
                                               const GEOSPreparedGeometry *pg1,
                                               const GEOSGeometry *g2,
                                               double *dist);
    ...
    /** \see GEOSSTRtree_create */
    extern GEOSSTRtree GEOS_DLL *
    GEOSSTRtree_create_r(GEOSContextHandle_t handle, size_t nodeCapacity);
    ...
    extern const GEOSGeometry GEOS_DLL *
    GEOSSTRtree_nearest_r(GEOSContextHandle_t handle, GEOSSTRtree *tree,
                          const GEOSGeometry *geom);

    /** \see GEOSSTRtree_nearest_generic */
    extern const void GEOS_DLL *GEOSSTRtree_nearest_generic_r(
        GEOSContextHandle_t handle, GEOSSTRtree *tree, const void *item,
        const GEOSGeometry *itemEnvelope, GEOSDistanceCallback distancefn,
        void *userdata);
    ...
    enum GEOSRelateBoundaryNodeRules
    {
        ...
        /** See
           geos::algorithm::BoundaryNodeRule::getBoundaryMultivalentEndPoint()
         */
        GEOSRELATE_BNR_MULTIVALENT_ENDPOINT = 3,
        /** See
           geos::algorithm::BoundaryNodeRule::getBoundaryMonovalentEndPoint() */
    ...
    extern char GEOS_DLL *
    GEOSRelateBoundaryNodeRule_r(GEOSContextHandle_t handle,
    ...
    extern char GEOS_DLL GEOSisValidDetail_r(GEOSContextHandle_t handle,
                                             const GEOSGeometry *g, int flags,
                                             char **reason,
    ...
    /** \see GEOSMakeValidWithParams */
    extern GEOSGeometry GEOS_DLL *
    GEOSMakeValidWithParams_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                              const GEOSMakeValidParams *makeValidParams);

    /** \see GEOSRemoveRepeatedPoints */
    extern GEOSGeometry GEOS_DLL *
    GEOSRemoveRepeatedPoints_r(GEOSContextHandle_t handle,
                               const GEOSGeometry *g, double tolerance);
    ...
    extern const GEOSGeometry GEOS_DLL *
    GEOSGetGeometryN_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                       int n);
    ...
    {
        /** The output is always valid. Collapsed geometry elements (including
           both polygons and lines) are removed. */
        GEOS_PREC_VALID_OUTPUT = 0,
        /** Precision reduction is performed pointwise. Output geometry may be
           invalid due to collapse or self-intersection. (This might be better
           called "GEOS_PREC_POINTWISE" - the current name is historical.) */
        GEOS_PREC_NO_TOPO = 1,
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_setPrecision_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                            double gridSize, int flags);

    /** \see GEOSGeom_getPrecision */
    extern double GEOS_DLL GEOSGeom_getPrecision_r(GEOSContextHandle_t handle,
                                                   const GEOSGeometry *g);
    ...
    /** \see GEOSGeomGetX */
    extern int GEOS_DLL GEOSGeomGetX_r(GEOSContextHandle_t handle,
                                       const GEOSGeometry *g, double *x);

    /** \see GEOSGeomGetY */
    extern int GEOS_DLL GEOSGeomGetY_r(GEOSContextHandle_t handle,
                                       const GEOSGeometry *g, double *y);

    /** \see GEOSGeomGetZ */
    extern int GEOS_DLL GEOSGeomGetZ_r(GEOSContextHandle_t handle,
                                       const GEOSGeometry *g, double *z);

    /** \see GEOSGetInteriorRingN */
    extern const GEOSGeometry GEOS_DLL *
    GEOSGetInteriorRingN_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                           int n);

    /** \see GEOSGetExteriorRing */
    extern const GEOSGeometry GEOS_DLL *
    GEOSGetExteriorRing_r(GEOSContextHandle_t handle, const GEOSGeometry *g);
    ...
    extern const GEOSCoordSequence GEOS_DLL *
    GEOSGeom_getCoordSeq_r(GEOSContextHandle_t handle, const GEOSGeometry *g);
    ...
    extern int GEOS_DLL GEOSGeom_getXMin_r(GEOSContextHandle_t handle,
                                           const GEOSGeometry *g,
                                           double *value);

    /** \see GEOSGeom_getYMin */
    extern int GEOS_DLL GEOSGeom_getYMin_r(GEOSContextHandle_t handle,
                                           const GEOSGeometry *g,
                                           double *value);

    /** \see GEOSGeom_getXMax */
    extern int GEOS_DLL GEOSGeom_getXMax_r(GEOSContextHandle_t handle,
                                           const GEOSGeometry *g,
                                           double *value);

    /** \see GEOSGeom_getYMax */
    extern int GEOS_DLL GEOSGeom_getYMax_r(GEOSContextHandle_t handle,
                                           const GEOSGeometry *g,
                                           double *value);

    /** \see GEOSGeom_getExtent */
    extern int GEOS_DLL GEOSGeom_getExtent_r(GEOSContextHandle_t handle,
                                             const GEOSGeometry *g,
                                             double *xmin, double *ymin,
                                             double *xmax, double *ymax);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSGeomGetPointN_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                        int n);

    /** \see GEOSGeomGetStartPoint */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeomGetStartPoint_r(GEOSContextHandle_t handle, const GEOSGeometry *g);

    /** \see GEOSGeomGetEndPoint */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeomGetEndPoint_r(GEOSContextHandle_t handle, const GEOSGeometry *g);
    ...
    extern char GEOS_DLL GEOSDistanceWithin_r(GEOSContextHandle_t handle,
                                              const GEOSGeometry *g1,
                                              const GEOSGeometry *g2,
                                              double dist);
    ...
    /** \see GEOSHilbertCode */
    extern int GEOS_DLL GEOSHilbertCode_r(GEOSContextHandle_t handle,
                                          const GEOSGeometry *geom,
    ...
    extern GEOSCoordSequence GEOS_DLL *
    GEOSNearestPoints_r(GEOSContextHandle_t handle, const GEOSGeometry *g1,
                        const GEOSGeometry *g2);

    /** \see GEOSGeom_transformXY */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_transformXY_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                           GEOSTransformXYCallback callback, void *userdata);
    ...
    /**
     * Reader object to read Well-Known Text (WKT) format and construct
     * Geometry. \see GEOSWKTReader_create \see GEOSWKTReader_create_r
     */
    ...
    /**
     * Reader object to read Well-Known Binary (WKB) format and construct
     * Geometry. \see GEOSWKBReader_create \see GEOSWKBReader_create_r
     */
    ...
    extern GEOSWKTReader GEOS_DLL *
    GEOSWKTReader_create_r(GEOSContextHandle_t handle);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSWKTReader_read_r(GEOSContextHandle_t handle, GEOSWKTReader *reader,
                         const char *wkt);

    /** \see GEOSWKTReader_setFixStructure */
    extern void GEOS_DLL GEOSWKTReader_setFixStructure_r(
        GEOSContextHandle_t handle, GEOSWKTReader *reader, char doFix);

    /* ========== WKT Writer ========== */

    /** \see GEOSWKTReader_create */
    extern GEOSWKTWriter GEOS_DLL *
    GEOSWKTWriter_create_r(GEOSContextHandle_t handle);
    ...
    extern GEOSWKBReader GEOS_DLL *
    GEOSWKBReader_create_r(GEOSContextHandle_t handle);
    ...
    extern void GEOS_DLL GEOSWKBReader_setFixStructure_r(
        GEOSContextHandle_t handle, GEOSWKBReader *reader, char doFix);

    /** \see GEOSWKBReader_read */
    extern GEOSGeometry GEOS_DLL *
    GEOSWKBReader_read_r(GEOSContextHandle_t handle, GEOSWKBReader *reader,
                         const unsigned char *wkb, size_t size);

    /** \see GEOSWKBReader_readHEX */
    extern GEOSGeometry GEOS_DLL *
    GEOSWKBReader_readHEX_r(GEOSContextHandle_t handle, GEOSWKBReader *reader,
                            const unsigned char *hex, size_t size);

    /* ========== WKB Writer ========== */

    /** \see GEOSWKBWriter_create */
    extern GEOSWKBWriter GEOS_DLL *
    GEOSWKBWriter_create_r(GEOSContextHandle_t handle);
    ...
    extern unsigned char GEOS_DLL *
    GEOSWKBWriter_write_r(GEOSContextHandle_t handle, GEOSWKBWriter *writer,
                          const GEOSGeometry *g, size_t *size);

    /** \see GEOSWKBWriter_writeHEX */
    extern unsigned char GEOS_DLL *
    GEOSWKBWriter_writeHEX_r(GEOSContextHandle_t handle, GEOSWKBWriter *writer,
                             const GEOSGeometry *g, size_t *size);

    /** \see GEOSWKBWriter_getOutputDimension */
    extern int GEOS_DLL GEOSWKBWriter_getOutputDimension_r(
        GEOSContextHandle_t handle, const GEOSWKBWriter *writer);

    /** \see GEOSWKBWriter_setOutputDimension */
    extern void GEOS_DLL GEOSWKBWriter_setOutputDimension_r(
        GEOSContextHandle_t handle, GEOSWKBWriter *writer, int newDimension);
    ...
    extern void GEOS_DLL GEOSWKBWriter_setByteOrder_r(
        GEOSContextHandle_t handle, GEOSWKBWriter *writer, int byteOrder);

    /** \see GEOSWKBWriter_getFlavor */
    extern int GEOS_DLL GEOSWKBWriter_getFlavor_r(GEOSContextHandle_t handle,
                                                  const GEOSWKBWriter *writer);

    /** \see GEOSWKBWriter_setFlavor */
    extern void GEOS_DLL GEOSWKBWriter_setFlavor_r(GEOSContextHandle_t handle,
                                                   GEOSWKBWriter *writer,
                                                   int flavor);
    ...
    /** \see GEOSGeoJSONReader_create */
    extern GEOSGeoJSONReader GEOS_DLL *
    GEOSGeoJSONReader_create_r(GEOSContextHandle_t handle);
    ...
    extern GEOSGeometry GEOS_DLL *
    GEOSGeoJSONReader_readGeometry_r(GEOSContextHandle_t handle,
                                     GEOSGeoJSONReader *reader,
                                     const char *geojson);
    ...
    extern GEOSGeoJSONWriter GEOS_DLL *
    GEOSGeoJSONWriter_create_r(GEOSContextHandle_t handle);
    ...
    extern char GEOS_DLL *
    GEOSGeoJSONWriter_writeGeometry_r(GEOSContextHandle_t handle,
                                      GEOSGeoJSONWriter *writer,
 ...
 */
     ...
     */
    extern GEOSCoordSequence GEOS_DLL *GEOSCoordSeq_create(unsigned int size,
                                                           unsigned int dims);

    /**
     * Create a coordinate sequence by copying from a buffer of doubles (XYXY or
     * XYZXYZ) \param buf pointer to buffer \param size number of coordinates in
     * the sequence \param hasZ does buffer have Z values? \param hasM does
     * buffer have M values? (they will be ignored) \return the sequence or NULL
     * on exception
     */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_copyFromBuffer(const double *buf, unsigned int size, int hasZ,
                                int hasM);
     ...
     */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_copyFromArrays(const double *x, const double *y,
                                const double *z, const double *m,
                                unsigned int size);

    /**
     * Copy the contents of a coordinate sequence to a buffer of doubles (XYXY
     * or XYZXYZ) \param s sequence to copy \param buf buffer to which
     * coordinates should be copied \param hasZ copy Z values to buffer? \param
     * hasM copy M values to buffer? (will be NaN) \return 1 on success, 0 on
     * error
     */
    extern int GEOS_DLL GEOSCoordSeq_copyToBuffer(const GEOSCoordSequence *s,
                                                  double *buf, int hasZ,
                                                  int hasM);

    /**
     * Copy the contents of a coordinate sequence to a buffer of doubles (XYZY
     * or XYZXYZ) \param s sequence to copy \param x array to which x values
     * should be copied \param y array to which y values should be copied \param
     * z array to which z values should be copied, or NULL \param m array to
     * which m values should be copied (will all be NAN) \return 1 on success, 0
     * on error
     */
    extern int GEOS_DLL GEOSCoordSeq_copyToArrays(const GEOSCoordSequence *s,
                                                  double *x, double *y,
                                                  double *z, double *m);
     ...
     */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSCoordSeq_clone(const GEOSCoordSequence *s);
     ...
     * \param s the coordinate sequence
     * \param is_ccw pointer for ccw value, 1 if counter-clockwise orientation,
     * 0 otherwise \return 0 on exception, 1 on success
     */
    extern int GEOS_DLL GEOSCoordSeq_isCCW(const GEOSCoordSequence *s,
                                           char *is_ccw);
     ...
     * Caller is responsible for freeing with GEOSGeom_destroy().
     */
    extern GEOSGeometry GEOS_DLL *GEOSGeom_createPointFromXY(double x,
                                                             double y);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_createCollection(int type, GEOSGeometry **geoms,
                              unsigned int ngeoms);
     ...
     */
    extern GEOSGeometry GEOS_DLL *GEOSGeom_createRectangle(double xmin,
                                                           double ymin,
                                                           double xmax,
                                                           double ymax);
     ...
     * \warning For GEOS < 3.2 this function may crash when fed simple
     * geometries
     */
    ...
    *       return the input).
    */
    extern const GEOSGeometry GEOS_DLL *GEOSGetGeometryN(const GEOSGeometry *g,
                                                         int n);
     ...
     * \return LinearRing geometry. Owned by parent geometry, do not free. NULL
     * on exception.
     */
    extern const GEOSGeometry GEOS_DLL *
    GEOSGetInteriorRingN(const GEOSGeometry *g, int n);
     ...
     */
    extern const GEOSGeometry GEOS_DLL *
    GEOSGetExteriorRing(const GEOSGeometry *g);
     ...
     */
    extern const GEOSCoordSequence GEOS_DLL *
    GEOSGeom_getCoordSeq(const GEOSGeometry *g);
     ...
     */
    extern int GEOS_DLL GEOSGeom_getExtent(const GEOSGeometry *g, double *xmin,
     ...
     *         NULL on exception.
     */
    extern GEOSGeometry GEOS_DLL *GEOSGeomGetPointN(const GEOSGeometry *g,
                                                    int n);
     ...
     *
     * Use before calling \ref GEOSEqualsExact to avoid false "not equal"
     * results. \param g Input geometry \return 0 on success or -1 on exception
     */
    ...
    */
     ...
     * \param location A pointer in which the location GEOSGeometry will be
     * placed \return 1 when valid, 0 when invalid, 2 on exception
     */
    extern char GEOS_DLL GEOSisValidDetail(const GEOSGeometry *g, int flags,
                                           char **reason,
                                           GEOSGeometry **location);
     ...
     * \param makeValidParams is a GEOSMakeValidParams with the desired
     * parameters set on it. \return A repaired geometry. Caller must free with
     * GEOSGeom_destroy(). \see GEOSMakeValidParams_create \see
     * GEOSMakeValidParams_destroy \see GEOSMakeValidParams_setMethod \see
     * GEOSMakeValidParams_setKeepCollapsed
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSMakeValidWithParams(const GEOSGeometry *g,
                            const GEOSMakeValidParams *makeValidParams);
    ...
    extern int GEOS_DLL GEOSMakeValidParams_setMethod(
        GEOSMakeValidParams *p, enum GEOSMakeValidMethods method);

    /**
     * When this parameter is nn-zero, the GEOS_MAKE_VALID_STRUCTURE method will
     * keep components that have collapsed into a lower dimensionality. For
     * example, a ring collapsing to a line, or a line collapsing to a point.
     * \return 0 on exception, 1 on success.
     * \see GEOSMakeValidWithParams
     */
    ...
    /**
     * Computes the minimum clearance of a geometry.  The minimum clearance is
     * the smallest amount by which a vertex could be move to produce an invalid
     * polygon, a non-simple linestring, or a multipoint with repeated points.
     * If a geometry has a minimum clearance of 'eps', it can be said that:
     *
     * -  No two distinct vertices in the geometry are separated by less than
     * 'eps'
     * -  No vertex is closer than 'eps' to a line segment of which it is not an
     * endpoint.
     *
     * If the minimum clearance cannot be defined for a geometry (such as with a
     * single point, or a multipoint whose points are identical, a value of
     * Infinity will be calculated.
     *
     ...
     * geometry. If the geometry has no minimum clearance, an empty LineString
     * will be returned.
     *
     * \param g the input geometry
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSMinimumClearanceLine(const GEOSGeometry *g);
     ...
     *
     * \return A geometry with all points within the tolerance of each other
     * removed. \param g The geometry to filter \param tolerance Remove all
     * points within this distance of each other. Use 0.0 to remove only exactly
     * repeated points.
     *
     * \see GEOSMakeValidWithParams
     */
     ...
     * \return 1 on success, 0 on exception.
     */
    extern int GEOS_DLL GEOSGeomGetLength(const GEOSGeometry *g,
                                          double *length);
     ...
     * \return 1 on success, 0 on exception.
     */
    extern int GEOS_DLL GEOSDistance(const GEOSGeometry *g1,
                                     const GEOSGeometry *g2, double *dist);
     ...
     */
    extern char GEOS_DLL GEOSDistanceWithin(const GEOSGeometry *g1,
                                            const GEOSGeometry *g2,
                                            double dist);
     ...
     */
    extern int GEOS_DLL GEOSDistanceIndexed(const GEOSGeometry *g1,
                                            const GEOSGeometry *g2,
                                            double *dist);

    /**
     * The closest points of the two geometries.
     * The first point comes from g1 geometry and the second point comes from
     * g2.
     *
     * \param[in] g1 Input geometry
     * \param[in] g2 Input geometry
     ...
     */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSNearestPoints(const GEOSGeometry *g1, const GEOSGeometry *g2);
     ...
     * The returned point is not guaranteed to intersect the line due to
     * limitations of floating point calculations. \param line linear target of
     * projection \param d distance from start of line to created point \return
     * The point \ref GEOSGeometry that is distance from the start of line.
     ...
     * \return The point \ref GEOSGeometry that is distance from the start of
     * line. Caller takes ownership of returned geometry.
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSInterpolateNormalized(const GEOSGeometry *line, double proportion);
     ...
     * \return A newly allocated geometry of the intersection. NULL on
     * exception. Caller is responsible for freeing with GEOSGeom_destroy().
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSIntersection(const GEOSGeometry *g1,
                                                   const GEOSGeometry *g2);
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSIntersectionPrec(const GEOSGeometry *g1,
                                                       const GEOSGeometry *g2,
                                                       double gridSize);
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSDifference(const GEOSGeometry *ga,
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSDifferencePrec(const GEOSGeometry *ga,
                                                     const GEOSGeometry *gb,
                                                     double gridSize);

    /**
     * Returns the symmetric difference of two geometries A and B: the set of
     * points that fall in A but **not** within B and the set of points that
     * fall in B but
     * **not** in A.
     * \param ga geometry A
     * \param gb geometry B
     * \return A newly allocated geometry of the symmetric difference. NULL on
     * exception. Caller is responsible for freeing with GEOSGeom_destroy().
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSSymDifference(const GEOSGeometry *ga,
                                                    const GEOSGeometry *gb);
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSSymDifferencePrec(const GEOSGeometry *ga,
                                                        const GEOSGeometry *gb,
                                                        double gridSize);
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSUnion(const GEOSGeometry *ga,
                                            const GEOSGeometry *gb);
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSUnionPrec(const GEOSGeometry *ga,
                                                const GEOSGeometry *gb,
                                                double gridSize);
     ...
     * \see geos::operation::overlayng::OverlayNG
     */
    extern GEOSGeometry GEOS_DLL *GEOSUnaryUnionPrec(const GEOSGeometry *g,
                                                     double gridSize);
     ...
     */
    extern GEOSGeometry GEOS_DLL *GEOSClipByRect(const GEOSGeometry *g,
                                                 double xmin, double ymin,
                                                 double xmax, double ymax);
     ...
     * \return 0 on exception, 1 on success.
     */
    extern int GEOS_DLL GEOSBufferParams_setEndCapStyle(GEOSBufferParams *p,
                                                        int style);
     ...
     * \return 0 on exception, 1 on success.
     */
    extern int GEOS_DLL GEOSBufferParams_setJoinStyle(GEOSBufferParams *p,
                                                      int joinStyle);
     ...
     * \return 0 on exception, 1 on success.
     */
    extern int GEOS_DLL GEOSBufferParams_setMitreLimit(GEOSBufferParams *p,
                                                       double mitreLimit);
     ...
     * \return 0 on exception, 1 on success.
     */
    extern int GEOS_DLL GEOSBufferParams_setSingleSided(GEOSBufferParams *p,
                                                        int singleSided);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSBufferWithParams(const GEOSGeometry *g, const GEOSBufferParams *p,
                         double width);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSBufferWithStyle(const GEOSGeometry *g, double width, int quadsegs,
     ...
     * - For a Polygon the result is the boundary lines(s) of the polygon
     * buffered to the offset distance (which may be a MultiLineString).
     * - For a collection the result is a collection of the element offset
     * curves. \param g The linear geometry to offset from \param width Distance
     * to offset from the curve. Negative for a right-side offset. Positive for
     * a left-side offset. \param quadsegs Number of segments per quadrant
     * \param joinStyle See \ref GEOSBufJoinStyles
     * \param mitreLimit See GEOSBufferParams_setMitreLimit
     ...
     * \return A newly allocated geometry of the concave hull. NULL on
     * exception. The area ratio is the ratio of the concave hull area to the
     * convex hull area. 1 produces the convex hull; 0 produces maximum
     * concaveness. The Length Ratio is a fraction determining the length of the
     * longest edge in the computed hull.  1 produces the convex hull; 0
     * produces a hull with maximum concaveness Caller is responsible for
     * freeing with GEOSGeom_destroy(). \see geos::algorithm::hull::ConcaveHull
     */
    extern GEOSGeometry GEOS_DLL *GEOSConcaveHull(const GEOSGeometry *g,
                                                  double ratio,
                                                  unsigned int allowHoles);
     ...
     * A value of 1 produces the convex hull; a value of 0 produces the original
     * geometry. An outer hull is computed if the parameter is positive, an
     * inner hull is computed if it is negative.
     *
     * \param g the polygonal geometry to process
     * \param isOuter indicates whether to compute an outer or inner hull (1 for
     * outer hull, 0 for inner) \param vertexNumFraction the target fraction of
     * the count of input vertices to retain in result \return A newly allocated
     * geometry of the concave hull. NULL on exception.
     *
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * \see geos::simplify::PolygonHullSimplifier
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonHullSimplify(const GEOSGeometry *g, unsigned int isOuter,
     ...
     * \param g the polygonal geometry to process
     * \param isOuter indicates whether to compute an outer or inner hull (1 for
     * outer hull, 0 for inner) \param parameterMode the interpretation to apply
     * to the parameter argument \param parameter the target ratio of area
     * difference to original area \return A newly allocated geometry of the
     * concave hull. NULL on exception.
     *
     * Caller is responsible for freeing with GEOSGeom_destroy().
     * \see geos::simplify::PolygonHullSimplifier
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonHullSimplifyMode(const GEOSGeometry *g, unsigned int isOuter,
                                unsigned int parameterMode, double parameter);
     ...
     * polygons. A given set of polygons has a sequence of hulls of increasing
     * concaveness, determined by a numeric target parameter. The computed hull
     * "fills the gap" between the polygons, and does not intersect their
     * interior.
     *
     ...
     *
     * "Maximum Edge Length" constrains the length of the longest edge between
     * the polygons to be no larger than this value.
     *
     ...
     * polygons. \return A newly allocated geometry of the concave hull. NULL on
     * exception.
     *
     * Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSConcaveHullOfPolygons(const GEOSGeometry *g, double lengthRatio,
     ...
     * \param g The input geometry
     * \return A newly allocated geometry of the rotated envelope. NULL on
     * exception. Caller is responsible for freeing with GEOSGeom_destroy().
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSMinimumRotatedRectangle(const GEOSGeometry *g);
     ...
     * which has the farthest distance from the area boundary, along with a
     * boundary point at that distance. In the context of geography the center
     * of the MIC is known as the "pole of inaccessibility". A cartographic use
     * case is to determine a suitable point to place a map label within a
     * polygon. The radius length of the MIC is a  measure of how "narrow" a
     ...
     * other on the boundary of the inscribed circle. \param g Input geometry
     * \param tolerance Stop the algorithm when the search area is smaller than
     * this tolerance \return A newly allocated geometry of the MIC. NULL on
     * exception. Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * indicating the circle radius. The implementation uses a
     * successive-approximation technique over a grid of square cells covering
     * the obstacles and boundary. The grid is refined using a branch-and-bound
     * algorithm.  Point containment and distance are computed in a performant
     * way by using spatial indexes.
     * Returns a two-point linestring, with the start point at the center of the
     * inscribed circle and the end on the boundary of the inscribed circle.
     * \param obstacles The geometries that the LEC must fit within without
     * covering \param boundary The area within which the LEC must reside \param
     * tolerance Stop the algorithm when the search area is smaller than this
     * tolerance \return A newly allocated geometry of the LEC. NULL on
     * exception. Caller is responsible for freeing with GEOSGeom_destroy().
     * \see geos::algorithm::construct::LargestEmptyCircle
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSLargestEmptyCircle(const GEOSGeometry *obstacles,
                           const GEOSGeometry *boundary, double tolerance);

    /**
     * Returns a linestring geometry which represents the minimum diameter of
     * the geometry. The minimum diameter is defined to be the width of the
     ...
     * rotation. \param g The input geometry \return A newly allocated geometry
     * of the LEC. NULL on exception. Caller is responsible for freeing with
     * GEOSGeom_destroy(). \see geos::algorithm::MinimumDiameter
     */
     ...
     * \param[out] center Pointer will be filled with output circle center.
     * Caller must free. \return The circle geometry or NULL on exception Caller
     * is responsible for freeing with GEOSGeom_destroy(). \see
     * geos::algorithm::MinimumBoundingCircle::getCircle
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSMinimumBoundingCircle(const GEOSGeometry *g, double *radius,
                              GEOSGeometry **center);
     ...
     * \param tolerance optional snapping tolerance to use for improved
     * robustness \param onlyEdges if non-zero will return a MultiLineString,
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSDelaunayTriangulation(const GEOSGeometry *g, double tolerance,
                              int onlyEdges);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSConstrainedDelaunayTriangulation(const GEOSGeometry *g);
     ...
     * Caller is responsible for freeing with GEOSGeom_destroy().
     */
    extern GEOSGeometry GEOS_DLL *GEOSVoronoiDiagram(const GEOSGeometry *g,
     ...
     * Functions computing noding of lines, and forming noded lines into
     * polygons.
     */
    ///@{
     ...
     *
     * \param geoms Array of linear geometries to polygons. Caller retains
     * ownersihp of both array container and objects. \param ngeoms Size of the
     * geoms array. \return The polygonal output geometry. Caller is responsible
     * for freeing with GEOSGeom_destroy(). \see
     * geos::operation::polygonize::Polygonizer
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonize(const GEOSGeometry *const geoms[], unsigned int ngeoms);

    /**
     * Same polygonizing behavior as GEOSPolygonize(), but only returning
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonize_valid(const GEOSGeometry *const geoms[],
                         unsigned int ngeoms);
     ...
     * \param geoms Array of linear geometries to polygons. Caller retains
     * ownersihp of both array container and objects. \param ngeoms Size of the
     * geoms array. \return The "cut edges" Caller is responsible for freeing
     * with GEOSGeom_destroy(). \see geos::operation::polygonize::Polygonizer
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSPolygonizer_getCutEdges(const GEOSGeometry *const geoms[],
                                unsigned int ngeoms);
     ...
     *
     * \param[in] input A single geometry with all the input lines to
     * polygonize. \param[out] cuts Pointer to hold "cut edges", connected on
     * both ends but not part of output. Caller must free. \param[out] dangles
     * Pointer to hold "dangles", connected one end but not part of output.
     * Caller must free. \param[out] invalid Pointer to hold invalid outputs,
     * polygons formed but not valid. Caller must free. \return The polygonal
     * valid output Caller is responsible for freeing with GEOSGeom_destroy().
     ...
     * Caller is responsible for freeing with GEOSGeom_destroy().
     */
    extern GEOSGeometry GEOS_DLL *GEOSDensify(const GEOSGeometry *g,
                                              double tolerance);
     ...
     * \param g The input geometry
     * \param tolerance The tolerance to apply. Larger tolerance leads to
     * simpler output. \return The simplified geometry Caller is responsible for
     * freeing with GEOSGeom_destroy(). \see
     * geos::simplify::DouglasPeuckerSimplifier
     */
    extern GEOSGeometry GEOS_DLL *GEOSSimplify(const GEOSGeometry *g,
                                               double tolerance);
     ...
     * Removes "unnecessary" vertices, vertices
     * that are co-linear within the tolerance distance.
     * Returns a valid output geometry, checking for collapses,
     * ring-intersections, etc and attempting to avoid. More computationally
     * expensive than GEOSSimplify() \param g The input geometry \param
     * tolerance The tolerance to apply. Larger tolerance leads to simpler
     * output. \return The simplified geometry Caller is responsible for freeing
     * with GEOSGeom_destroy(). \see geos::simplify::DouglasPeuckerSimplifier
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSTopologyPreserveSimplify(const GEOSGeometry *g, double tolerance);
     ...
     * This allows sorting geometries in a deterministic way, such that similar
     * Hilbert codes are likely to be near each other in two-dimensional space.
     * The caller must ensure that the geometry is contained within the extent.
     * \param[in] geom Input geometry, must be non-empty
     * \param[in] extent Extent within which to calculate the Hilbert code for
     * geom \param[in] level The level of precision of the Hilbert curve, up to
     * 16 \param[out] code Pointer to be filled in with Hilbert code result
     * \return 1 on success, 0 on exception.
     */
    extern int GEOS_DLL GEOSHilbertCode(const GEOSGeometry *geom,
                                        const GEOSGeometry *extent,
                                        unsigned int level, unsigned int *code);

    /**
    * Apply XY coordinate transform callback to all coordinates in a copy of
    * input geometry.  If the callback returns an error, returned geometry will
    be
    ...
    * \param[in] callback a function to be executed for each coordinate in the
                    geometry.  The callback takes 3 parameters: x and y
    coordinate values to be updated and a void userdata pointer.
    * \param userdata an optional pointer to pe passed to 'callback' as an
    argument
    * \return a copy of the input geometry with transformed coordinates.
    * Caller must free with GEOSGeom_destroy().
    */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeom_transformXY(const GEOSGeometry *g,
                         GEOSTransformXYCallback callback, void *userdata);
     ...
     * Caller is responsible for freeing with GEOSGeom_destroy().
     */
    extern GEOSGeometry GEOS_DLL *GEOSSnap(const GEOSGeometry *input,
     ...
     * \param flags The bitwise OR of members of the \ref GEOSPrecisionRules
     * enum \return The precision reduced result. Caller must free with
     * GEOSGeom_destroy() NULL on exception.
     */
    extern GEOSGeometry GEOS_DLL *
     ...
     * Functions computing binary spatial predicates using the DE-9IM topology
     * model.
     */
    ///@{
     ...
     */
    extern char GEOS_DLL GEOSDisjoint(const GEOSGeometry *g1,
                                      const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSTouches(const GEOSGeometry *g1,
                                     const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSIntersects(const GEOSGeometry *g1,
                                        const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSCrosses(const GEOSGeometry *g1,
                                     const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSWithin(const GEOSGeometry *g1,
                                    const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSContains(const GEOSGeometry *g1,
                                      const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSOverlaps(const GEOSGeometry *g1,
                                      const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSEquals(const GEOSGeometry *g1,
                                    const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSCovers(const GEOSGeometry *g1,
                                    const GEOSGeometry *g2);
     ...
     */
    extern char GEOS_DLL GEOSCoveredBy(const GEOSGeometry *g1,
                                       const GEOSGeometry *g2);
     ...
     * Unlike GEOSEquals(), geometries that are topologically equivalent but
     * have different representations (e.g., LINESTRING (0 0, 1 1) and
     * MULTILINESTRING ((0 0, 1 1)) ) are not considered equal by
     * GEOSEqualsExact(). \param g1 Input geometry \param g2 Input geometry
     * \param tolerance Tolerance to determine vertex equality
     * \returns 1 on true, 0 on false, 2 on exception
     * \see GEOSNormalize()
     */
    extern char GEOS_DLL GEOSEqualsExact(const GEOSGeometry *g1,
                                         const GEOSGeometry *g2,
                                         double tolerance);
     ...
     * \return 1 on true, 0 on false, 2 on exception
     */
    extern char GEOS_DLL GEOSRelatePattern(const GEOSGeometry *g1,
                                           const GEOSGeometry *g2,
                                           const char *pat);
     ...
     *         NULL on exception
     */
    extern char GEOS_DLL *GEOSRelate(const GEOSGeometry *g1,
                                     const GEOSGeometry *g2);
     ...
     * \return 1 on true, 0 on false, 2 on exception
     */
    extern char GEOS_DLL GEOSRelatePatternMatch(const char *mat,
                                                const char *pat);
     ...
     * over again for predicate tests, wrapping it in a \ref
     * GEOSPreparedGeometry is a best practice.
     *
     * Prepared Geometry supports some binary spatial predicates and distance
     * calculations.
     */
    ///@{
     ...
     */
    extern const GEOSPreparedGeometry GEOS_DLL *
    GEOSPrepare(const GEOSGeometry *g);
     ...
     * \see GEOSContains
     */
    extern char GEOS_DLL GEOSPreparedContains(const GEOSPreparedGeometry *pg1,
                                              const GEOSGeometry *g2);
    ...
    extern char GEOS_DLL GEOSPreparedContainsProperly(
        const GEOSPreparedGeometry *pg1, const GEOSGeometry *g2);
     ...
     * \see GEOSCoveredBy
     */
    extern char GEOS_DLL GEOSPreparedCoveredBy(const GEOSPreparedGeometry *pg1,
                                               const GEOSGeometry *g2);
     ...
     * \see GEOSCovers
     */
    extern char GEOS_DLL GEOSPreparedCovers(const GEOSPreparedGeometry *pg1,
                                            const GEOSGeometry *g2);
     ...
     * \see GEOSCrosses
     */
    extern char GEOS_DLL GEOSPreparedCrosses(const GEOSPreparedGeometry *pg1,
                                             const GEOSGeometry *g2);
     ...
     * \see GEOSDisjoin
     */
    extern char GEOS_DLL GEOSPreparedDisjoint(const GEOSPreparedGeometry *pg1,
                                              const GEOSGeometry *g2);
     ...
     * \see GEOSDisjoin
     */
    extern char GEOS_DLL GEOSPreparedIntersects(const GEOSPreparedGeometry *pg1,
                                                const GEOSGeometry *g2);
     ...
     * \see GEOSOverlaps
     */
    extern char GEOS_DLL GEOSPreparedOverlaps(const GEOSPreparedGeometry *pg1,
                                              const GEOSGeometry *g2);
     ...
     * \see GEOSTouches
     */
    extern char GEOS_DLL GEOSPreparedTouches(const GEOSPreparedGeometry *pg1,
                                             const GEOSGeometry *g2);
     ...
     * \see GEOSWithin
     */
    extern char GEOS_DLL GEOSPreparedWithin(const GEOSPreparedGeometry *pg1,
                                            const GEOSGeometry *g2);
     ...
     * \param pg1 The prepared geometry
     * \param g2 The geometry to test
     * \returns A coordinate sequence containing the nearest points, or NULL on
     * exception. The first point in the sequence is from the prepared geometry,
     * and the seconds is from the other argument.
     */
    extern GEOSCoordSequence GEOS_DLL *
    GEOSPreparedNearestPoints(const GEOSPreparedGeometry *pg1,
                              const GEOSGeometry *g2);
     ...
     * \return 1 on success
     */
    extern int GEOS_DLL GEOSPreparedDistance(const GEOSPreparedGeometry *pg1,
                                             const GEOSGeometry *g2,
                                             double *dist);
    ...
    extern char GEOS_DLL GEOSPreparedDistanceWithin(
        const GEOSPreparedGeometry *pg1, const GEOSGeometry *g2, double dist);

    ///@}

    /* ========== STRtree functions ========== */
    /** @name STRtree
     * A \ref GEOSSTRtree is a R-tree spatial index structure for two
     * dimensional data. It uses the
     * [Sort-Tile-Recursive](https://en.wikipedia.org/wiki/R-tree) packing
     * algorithm.
     */
    ///@{
     ...
     *
     * \param nodeCapacity The maximum number of child nodes that a node may
     * have. The minimum recommended capacity value is 4. If unsure, use a
     * default node capacity of 10. \return a pointer to the created tree
     */
     ...
     * \param g a GEOSGeometry whose envelope corresponds to the extent of
     * 'item'. As of GEOS 3.9, this envelope will be copied into the tree and
     * the caller may destroy `g` while the tree is still in use. Before
     * GEOS 3.9, `g` must be retained until the tree is destroyed. \param item
     * the item to insert into the tree \note The tree does **not** take
     * ownership of the geometry or the item.
     */
    extern void GEOS_DLL GEOSSTRtree_insert(GEOSSTRtree *tree,
                                            const GEOSGeometry *g, void *item);
     ...
     * \param callback a function to be executed for each item in the tree whose
     * envelope intersects the envelope of 'g'.  The callback function should
     * take two parameters: a void pointer representing the located item in the
     * tree, and a void userdata pointer. \param userdata an optional pointer to
     * pe passed to 'callback' as an argument
     */
    ...
    /**
     * Returns the nearest item in the \ref GEOSSTRtree to the supplied
     * geometry. All items in the tree MUST be of type \ref GEOSGeometry. If
     * this is not the case, use GEOSSTRtree_nearest_generic() instead.
     *
     * \param tree the \ref GEOSSTRtree to search
     * \param geom the geometry with which the tree should be queried
     * \return a const pointer to the nearest \ref GEOSGeometry in the tree to
     * 'geom', or NULL in case of exception
     */
    extern const GEOSGeometry GEOS_DLL *
    GEOSSTRtree_nearest(GEOSSTRtree *tree, const GEOSGeometry *geom);
     ...
     * \param distancefn a function that can compute the distance between two
     * items in the STRtree.  The function should return zero in case of error,
     *            and should store the computed distance to the location pointed
     * to by the 'distance' argument.  The computed distance between two items
     *            must not exceed the Cartesian distance between their
     * envelopes. \param userdata optional pointer to arbitrary data; will be
     * passed to distancefn each time it is called. \return a const pointer to
     * the nearest item in the tree to 'item', or NULL in case of exception
     */
    extern const void GEOS_DLL *GEOSSTRtree_nearest_generic(
        GEOSSTRtree *tree, const void *item, const GEOSGeometry *itemEnvelope,
        GEOSDistanceCallback distancefn, void *userdata);
     ...
     */
    extern int GEOS_DLL GEOSSegmentIntersection(double ax0, double ay0,
                                                double ax1, double ay1,
                                                double bx0, double by0,
                                                double bx1, double by1,
                                                double *cx, double *cy);
     ...
     */
    extern int GEOS_DLL GEOSOrientationIndex(double Ax, double Ay, double Bx,
                                             double By, double Px, double Py);
     ...
     */
    extern GEOSGeometry GEOS_DLL *GEOSWKTReader_read(GEOSWKTReader *reader,
                                                     const char *wkt);
     ...
     */
    extern void GEOS_DLL GEOSWKTReader_setFixStructure(GEOSWKTReader *reader,
                                                       char doFix);
     ...
     * \param g Input geometry
     * \return A newly allocated string containing the WKT output or NULL on
     * exception. Caller must free with GEOSFree()
     */
    extern char GEOS_DLL *GEOSWKTWriter_write(GEOSWKTWriter *writer,
                                              const GEOSGeometry *g);
     ...
     * default 'off'
     */
    extern void GEOS_DLL GEOSWKTWriter_setTrim(GEOSWKTWriter *writer,
                                               char trim);
     ...
     */
    extern void GEOS_DLL
    GEOSWKTWriter_setRoundingPrecision(GEOSWKTWriter *writer, int precision);
     ...
     */
    extern void GEOS_DLL GEOSWKTWriter_setOutputDimension(GEOSWKTWriter *writer,
                                                          int dim);
     ...
     */
    extern void GEOS_DLL GEOSWKTWriter_setOld3D(GEOSWKTWriter *writer,
                                                int useOld3D);
    ///@}
     ...
     * \param doFix Set to 1 to repair, 0 for no repair (default).
     */
    extern void GEOS_DLL GEOSWKBReader_setFixStructure(GEOSWKBReader *reader,
                                                       char doFix);
     ...
     */
    extern GEOSGeometry GEOS_DLL *GEOSWKBReader_read(GEOSWKBReader *reader,
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSWKBReader_readHEX(GEOSWKBReader *reader, const unsigned char *hex,
                          size_t size);
     ...
     */
    extern unsigned char GEOS_DLL *GEOSWKBWriter_write(GEOSWKBWriter *writer,
                                                       const GEOSGeometry *g,
                                                       size_t *size);
     ...
     */
    extern unsigned char GEOS_DLL *GEOSWKBWriter_writeHEX(GEOSWKBWriter *writer,
                                                          const GEOSGeometry *g,
                                                          size_t *size);
     ...
     */
    extern void GEOS_DLL GEOSWKBWriter_setOutputDimension(GEOSWKBWriter *writer,
                                                          int newDimension);
     ...
     */
    extern int GEOS_DLL GEOSWKBWriter_getFlavor(const GEOSWKBWriter *writer);
     ...
     */
    extern void GEOS_DLL GEOSWKBWriter_setFlavor(GEOSWKBWriter *writer,
                                                 int flavor);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeoJSONReader_readGeometry(GEOSGeoJSONReader *reader,
                                   const char *geojson);
    ...
    /**
     * Write out the GeoJSON representation of a geometry. Note that writing a
     * GeoJSON Feature or FeatureCollection is unsupported through the GEOS C
     * API. \param writer A GeoJSON reader object, caller retains ownership.
     ...
     */
    extern char GEOS_DLL *
    GEOSGeoJSONWriter_writeGeometry(GEOSGeoJSONWriter *writer,
                                    const GEOSGeometry *g, int indent);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSSingleSidedBuffer(const GEOSGeometry *g, double width, int quadsegs,
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSSingleSidedBuffer_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                            double width, int quadsegs, int joinStyle,
                            double mitreLimit, int leftSide);

    /**
     * \deprecated in 3.5.0. Use GEOS_init_r() and set the message handlers
     * using GEOSContext_setNoticeHandler_r() and/or
     * GEOSContext_setErrorHandler_r()
     */
    extern GEOSContextHandle_t GEOS_DLL initGEOS_r(
        GEOSMessageHandler notice_function, GEOSMessageHandler error_function);
    ...
    /**
     * \deprecated use \ref GEOSWKBWriter and
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeomFromWKB_buf_r(GEOSContextHandle_t handle, const unsigned char *wkb,
                          size_t size);
     ...
     */
    extern unsigned char GEOS_DLL *
    GEOSGeomToWKB_buf_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                        size_t *size);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSGeomFromHEX_buf_r(GEOSContextHandle_t handle, const unsigned char *hex,
                          size_t size);
     ...
     */
    extern unsigned char GEOS_DLL *
    GEOSGeomToHEX_buf_r(GEOSContextHandle_t handle, const GEOSGeometry *g,
                        size_t *size);
     ...
     */
    extern unsigned char GEOS_DLL *GEOSGeomToWKB_buf(const GEOSGeometry *g,
                                                     size_t *size);

    /**
     * \deprecated use \ref GEOSWKBReader and GEOSWKBWriter_readHEX()
     */
    extern GEOSGeometry GEOS_DLL *GEOSGeomFromHEX_buf(const unsigned char *hex,
                                                      size_t size);

    /**
     * \deprecated use \ref GEOSWKBWriter and GEOSWKBWriter_writeHEX()
     */
    extern unsigned char GEOS_DLL *GEOSGeomToHEX_buf(const GEOSGeometry *g,
                                                     size_t *size);
     ...
     */
    extern GEOSGeometry GEOS_DLL *
    GEOSUnionCascaded_r(GEOSContextHandle_t handle, const GEOSGeometry *g);
